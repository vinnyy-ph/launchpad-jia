...
import { getAutomationSettings } from "@/lib/Utils";
...
export const POST = withAuth(async (request: AuthenticatedRequest) => {
  ...
  const screeningPrompt = `
    ...
    Processing Steps:
      ...
      - DO NOT mention the applicant's name in the reason property.
  `;
  ...
  const { cvScreeningAutoEndorse } = getAutomationSettings(careerDetails);
  ...
  await db.collection("recruiter-history").insertOne({
    ...
    action: "Generated CV Screening Result",
