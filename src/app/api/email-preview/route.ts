        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; background-color: #ffffff; border-radius: 8px; padding: 24px;">
          ...
          <tr>
            <td style="padding: 24px; text-align: center;">
              ...
              <a href="${LOGIN_URL}" style="display: inline-block; background-color: #181D27; color: #ffffff; padding: 12px 80px; border: 1px solid #999999; border-radius: 50px; text-decoration: none; font-size: 17px; font-weight: 600;">Log In</a>
            </td>
          </tr>
          
          <!-- Footer -->
          <tr>
            <td style="padding: 24px; text-align: center; font-size: 12px; color: #717680; line-height: 1.6;">
              <div style="font-weight: 600; margin-bottom: 4px;">© Jia</div>
              <p style="margin: 0;">Please do not reply to this email. This is a system generated email.</p>
            </td>
          </tr>
        </table>
      </td>
