  ...
  const handleSubmit = async () => {
    ...
    try {
      await api.post("/api/submit-feedback", {
        ...
        id: feedbackData.id,
        allowTestimonial: checkboxChecked,
      });
      onClose();
    } catch (err) {
      ...
      >
        ...
        >
          ...
          >
            ...
            {/* Star Rating */}
            <div className="feedback-star-row" style={{ marginBottom: "2rem" }}>
              {[1, 2, 3, 4, 5].map((index) => (
                <span
                  key={index}
                  style={{
          ...
          <style>
            {`
              .custom-checkbox {
                ...
                height: 20px;
                border-radius: 6px;
                border: 1px solid var(--Colors-Primary_Colors-Neutrals-900, #181D27);
                background: var(--Colors-Primary_Colors-Neutrals-50, #FAFAFA);
                appearance: none;
                cursor: pointer;
              ...
              .custom-checkbox:checked::after {
                ...
                font-size: 14px;
                color: #181D27; /* Adjust for contrast */
              }
          `}
          </style>

          {rating === 5 && feedback.trim() && (
            <div
              style={{
                display: "flex",
                gap: "0.5rem",
            ...
            >
              ...
              >
                Allow Jia to use this as a public testimonial
              </label>
            </div>
          )}
