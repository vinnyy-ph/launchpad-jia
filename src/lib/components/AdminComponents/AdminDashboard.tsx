...
export default function AdminDashboard() {
    ...
    useEffect(() => {
        const fetchTopCareers = async () => {
            try {
                ...
                const response = await api.get("/api/admin/get-top-careers", {
                    params: {
    ...
    useEffect(() => {
        const fetchTopOrganizations = async () => {
            try {
                ...
                const response = await api.get("/api/admin/get-top-organizations", {
                    params: {
    ...
    return (
        <div className="admin-dashboard-container">
             <div className="admin-dashboard-metrics-container">
               <div className="admin-dashboard-metric-card" style={{  backgroundColor: "#EFF8FF", minWidth: "360px" }}>
             ...
             <div className="admin-dashboard-metric-card" style={{  backgroundColor: "#FDF2FA", minWidth: "360px" }}>
                <div className="metric-content">
                    <div className="metric-icon">
            ...
            <div className="admin-dashboard-metric-card" style={{  backgroundColor: "#F4F3FF", minWidth: "360px" }}>
                <div className="metric-content">
                    <div className="metric-icon">
