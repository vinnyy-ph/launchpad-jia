...
export default function RetakeInterviewRequestV2({ interviewDetails, pipelineStages }: { interviewDetails: any, pipelineStages: any }) {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            if (action == "approve") {
              ...
              const currentPipelineStage = getCurrentPipelineStage(pipelineStages, {
                status: interviewDetails.status,
                currentStep: interviewDetails.currentStep,
              });
              ...
              await api.post("/api/update-interview", {
                ...
                interviewTransaction: {
                  ...
                  careerId: interviewDetails?.careerID,
